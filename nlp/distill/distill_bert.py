...
from transformers import BertForSequenceClassification, BertConfig, AdamW, BertTokenizerFast
...
student_model = BertForSequenceClassification(bert_config_l3)  # , num_labels = 2
